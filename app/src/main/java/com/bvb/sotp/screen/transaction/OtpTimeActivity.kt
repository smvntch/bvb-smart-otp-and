...
class OtpTimeActivity : MvpActivity<CreatePinCodePresenter>(), CreatePinCodeContract {
    ...
    override val layoutResId: Int
        get() = R.layout.activity_otp_time //To change initializer of created properties use File | Settings | File Templates.
...
//        trans_id.text = tranId
    ...
    fun onOkClick() {
        ...
        myClipboard?.setPrimaryClip(ClipData.newPlainText("text", edtActiveCode.text))// = myClip
    ...
    internal inner class GetServerTimeProcess : AsyncTask<Int, Void, String?>() {
        ...
        override fun onPreExecute() {
            super.onPreExecute()
            dialog = SpotsDialog.Builder().setContext(this@OtpTimeActivity).build()
            dialog!!.setTitle("")
        ...
        override fun onPostExecute(param: String?) {
            ...
            if (seconds != 0) {
                ...
                val dialog = DialogHelper(this@OtpTimeActivity)
    ...
    fun onBindOtp() {
        ...
        if (completeEntity != null) {
            ...
            Logger.log(Logger.DEBUG, this.javaClass, "otp is " + otp)
